...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // 2. Re-create the constraint with 'searching_for_driver' included
        DB::statement("
            ALTER TABLE orders ADD CONSTRAINT orders_status_check CHECK (
                (status)::text = ANY (ARRAY[
                    ...
                    'searching_for_driver'::character varying, -- Added new status
    ...
    public function down(): void
    {
        ...
        // 2. Re-create the original constraint without 'searching_for_driver'
        DB::statement("
            ALTER TABLE orders ADD CONSTRAINT orders_status_check CHECK (
                (status)::text = ANY (ARRAY[
                    'draft'::character varying,
